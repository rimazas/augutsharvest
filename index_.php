    ...
    <body>
        ...
        <div class="navbar-fixed-top mobmenu visible-xs">
          ...
          <nav id="mobmenu" class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav">
              ...
              <li><a class="scroll" data-scrollto="#services" data-open-block="#emergency-call">Emergency call</a></li>
            ...
            <div class="vertical-wrapper">
              <div class="vertical-center">
                ...
                <div id="services" class="services">
                    ...
                    <div id="shopping-session" class="service-block">
                      <div class="row">
                        <div class="col-md-12 col-lg-10 col-lg-offset-1">
                          <p>The ideal experience. Let's go shopping for a day or a couple of hours and show you where and how to shop. There are lots of places to shop that you may have had no idea existed: after this session you will no longer feel you are lost and wasting time.</p>                          
                        </div>
                      </div>
                      <i class="close"><span></span><span></span></i>
                    </div>                    
                  ...
                  <div>
                    <a data-scrollto="#services" class="scroll service-title" data-open-block="#emergency-call">Emergency call</a>
                    <div id="emergency-call" class="service-block">
                      <i class="close"><span></span><span></span></i>
                      <div class="row">
                        <div class="col-md-12 col-lg-10 col-lg-offset-1">                      
                          <p>A last minute invite comes in and you find yourself unprepared for an urgent event; obviously you want your clothes to help you achieve your best. Get in touch and the shopping will be done and delivered to you within a few hours.</p>
                        </div>
                      </div>
                    </div> 
                  </div>                  
            ...
            <div class="col-md-4">
              <div class="item engagement">
                ...
                <div class="text text1">
                  <p>That moment when you dread going shopping? Let’s work on this. First we will communicate, discussing your style, objectives, and budget. We will be in touch at your convenience to help and encourage you. </p>
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="item trust">
                ...
                <div class="text text2">
                  <p>Focus on what you like and what you're good at - let me deal with what you wear. A selection of images will be provided to inspire our upcoming shopping trip. Shopping has never been so relaxing and enjoyable. Let’s share the responsibilities and you will get the most out of it.</p>
                </div>
              </div>            
            </div>
            <div class="col-md-4">
              <div class="item evolvement">
                ...
                <div class="text text3">
                  <p>You become confident as what you wear is being taken care of. We'll meet, browse the shops, pick up some lunch and discuss the experience: understanding your personality, challenges and objectives will enable continuous style evolvement. </p>
                </div>
              </div>                       
            </div>
          </div>          
      ...
      <section id="inspiration" class="social hidden-xs">
        <div class="container">
          <div class="wrapper">
            ...
            <a href="http://www.lookbook.nu/augustharvest" class="link lookbook" target="_blank" rel="nofollow">
              <div class="overlay"></div>
              <img src="img/lookbook.jpg" alt="">
              <span>Lookbook</span>
            </a>   
            <a href="http://www.facebook.com/profile.php?id=1785502963" class="link facebook" target="_blank" rel="nofollow">
              <div class="overlay"></div>
      ...
      <section id="contacts" class="contacts">
              ...
              <div class="row">
                <div class="col-lg-12">
                  <div class="text">
                    ...
                    <p>Don't hesitate to contact me and we'll take it from there.</p>
                  </div>                  
                </div>
              </div> 
        ...
        <div class="social-icons">
          ...
          <a href="http://www.lookbook.nu/augustharvest" class="lookbook" target="_blank" rel="nofollow">
            <i class="lookbook-logo">LB</i>
          </a>
          <a href="http://www.facebook.com/profile.php?id=1785502963" class="facebook" target="_blank" rel="nofollow">
      ...
      <section id="legal" class="terms">
        <div class="container">
            <div class="text">
              <p>QUALITY CONTROL - every item will be checked on your behalf before purchase. Photos of each item will be taken before delivery and emailed to you for your reference. PAYMENTS - payment can be made on the day of appointment either in cash or through a bank payment. If shopping takes place without the client, all funds required to cover the budget must be paid in advance. All unwanted items can be returned with the original receipt within 7 days. APPOINTMENT DURATION - appointment duration will be given after our communication. If appointments run over time due to a particular circumstance or the client’s request, an additional hourly rate will be charged. CANCELLATION POLICY - AUGUST HARVEST reserves the right to request up to 25% deposit before any appointment can be secured. This deposit will not be refunded if the appointment is cancelled with less than 48 hours notice. PRIVACY - any personal information you provide via the Website or an AUGUST HARVEST service will be held securely and will not be passed to a third party unless required by law. Data Protection Act 1998. Third party legal stuff applies.</p><br>
              <p>Trading as AUGUST HARVEST, Empire Heights, London, SE14 5FA</p>  
              <p><span class="copyright">&copy; AUGUST HARVEST. All rights reserved.</span></p>
            </div>
